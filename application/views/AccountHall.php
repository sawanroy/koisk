...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarColor02">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?= base_url('main2_controller/index');?>">Feedback</a>
      </li>
      <li class="nav-item">
...
<div class="w3-content w3-section" style="width:500px ">
  <img class="mySlides" src="<?= base_url('assets/images/map/paths/Accounts/1.jpg')?>" style="width:100%">
  <img class="mySlides" src="<?= base_url('assets/images/map/paths/Accounts/2.jpg')?>" style="width:100%">
  <img class="mySlides" src="<?= base_url('assets/images/map/paths/Accounts/3.jpg')?>" style="width:100%">
  <img class="mySlides" src="<?= base_url('assets/images/map/paths/Accounts/4.jpg')?>" style="width:100%">
</div>
...
<div class="card-header">GOOGLE MAP VIEW</div>
  <div class="card-body">
    <iframe height="400" width="1400" src="https://www.google.co.in/maps/place/Hitkarini+College+of+Engineering+%26+Technology/@23.1636606,79.9962455,15z"></iframe>
