...
<div class="card-header">HCET COLLEGE MAPS</div>
 ...
 <a href="<?= base_url('main_controller/accounts');?>"><button type="button" class="btn btn-primary">Account Hall</button></a>
  ...
  <img class="mySlides" src="<?= base_url('assets/images/map/paths/Principaloffice/1.jpg')?>" style="width:100%">
  <img class="mySlides" src="<?= base_url('assets/images/map/paths/Principaloffice/2.jpg')?>" style="width:100%">
  <img class="mySlides" src="<?= base_url('assets/images/map/paths/Principaloffice/3.jpg')?>" style="width:100%">
  <img class="mySlides" src="<?= base_url('assets/images/map/paths/Principaloffice/4.jpg')?>" style="width:100%">
  <img class="mySlides" src="<?= base_url('assets/images/map/paths/Principaloffice/5.jpg')?>" style="width:100%">
</div>
