...
<script src="//code.jquery.com/jquery-1.11.1.min.js"></script>
 <link rel="stylesheet" type="text/css" href="<?= base_url('assets2/css/parallax.css')?>">
 <script src="<?= base_url('assets2/css/parallax.js')?>"></script>
  ...
  <?= $error ?>
    ...
    <?php endif;?>                               
                                <div class="row-fluid user-row">
                                    <img src="<?= base_url('assets2/css/images/logo_sm_2_mr_1.png')?>" class="img-responsive" alt="Conxole Admin"/>
                                </div>
                            </div>
