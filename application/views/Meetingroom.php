...
<div class="w3-content w3-section" style="width:500px ">
  <img class="mySlides" src="<?= base_url('assets/images/map/paths/meetingroom/1.jpg')?>" style="width:100%">
  <img class="mySlides" src="<?= base_url('assets/images/map/paths/meetingroom/2.jpg')?>" style="width:100%">
  <img class="mySlides" src="<?= base_url('assets/images/map/paths/meetingroom/3.jpg')?>" style="width:100%">
  <img class="mySlides" src="<?= base_url('assets/images/map/paths/meetingroom/4.jpg')?>" style="width:100%">
    <img class="mySlides" src="<?= base_url('assets/images/map/paths/meetingroom/5.jpg')?>" style="width:100%">
</div>
