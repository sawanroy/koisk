...
<title>ADMIN LOGIN | website</title>
<link rel="stylesheet" type="text/css" href="<?= base_url('assets2/css/bootstrap.min.css')?>" >
</head>
<body>
<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
   <a class="navbar-brand" href="www.hcet.hitkarini.com"><img height="50" src="<?= base_url('assets/kioskimage/logo2.png')?>"></a>
...
<div class="container">
 <?php echo form_open('admin_controller/index') ?>
