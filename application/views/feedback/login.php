  ...
  <div class="collapse navbar-collapse" id="navbarColor03">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="<?= base_url('main2_controller/index')?>">Home <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?= base_url('main2_controller/login')?>">Login</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="<?= base_url('main2_controller/admin')?>">Admin</a>
      </li>
      <li class="nav-item">
...
<div class="col-lg-4" style="float: right; margin-right: 100px;">
  <a href="<?= base_url('main2_controller/infra')?>" class="list-group-item list-group-item-action flex-column align-items-start active">
    <div class="d-flex w-100 justify-content-between">
      <h5 class="mb-1">Sumbit Your Feedback</h5>
    </div>
