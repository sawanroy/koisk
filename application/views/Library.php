...
<a href="<?= base_url('main_controller/accounts');?>"><button type="button" class="btn btn-primary">Account Hall</button></a>
  ...
  <img class="mySlides" src="<?= base_url('assets/images/map/paths/Library/1.jpg')?>" style="width:100%">
  <img class="mySlides" src="<?= base_url('assets/images/map/paths/Library/2.jpg')?>" style="width:100%">
  <img class="mySlides" src="<?= base_url('assets/images/map/paths/Library/3.jpg')?>" style="width:100%">
  <img class="mySlides" src="<?= base_url('assets/images/map/paths/Library/4.jpg')?>" style="width:100%">
</div>
